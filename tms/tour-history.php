...
<div class="banner-1 ">
	<div class="container">
		<h1 class="wow" style="visibility: visible;">Travel Management System</h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- privacy ---->
<div class="privacy">
	<div class="container">
		<h3 class="wow" data-wow-delay=".5s" style="visibility: visible;">My Tour History</h3>
